        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <img class="produto_imagem img-fluid mt-md-5 " src="../imagens/ventilador2.jpg" alt="">
                    <!--div com as informacoes do produto-->
                </div>
                <div class="col-md-4 p-3 mt-md-5">
                    <div class="produto_informacoes">
                        <p class="produto_nome">Ventilador de Mesa Mallory Turbo TS30 30 cm 6 Pás 3 Velocidades</p>
                        <p class="produto_cor"> <strong>Cor: </strong>Preto</p>
                        <p class="produto_descricao">R$ 99,99</p>
                        <p class="produto_valor">R$ 69,99</p>
