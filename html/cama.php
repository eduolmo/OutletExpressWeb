...
<body>
    ...
    <section class="primeiraSecao">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img class="produto_imagem mt-md-5" src="../imagens/cama.jpg" alt="">
                </div>
                <div class="col-md-4 p-3  mt-md-5">
                    <div class="produto_informacoes">
                        <p class="produto_nome">Cama Casal Madeira Maciça - Lisboa - Móveis Montanhês</p>
                        <p class="produto_cor"> <strong>Cor: </strong>Marrom</p>
                        <p class="produto_descricao">R$ 1.954,99</p>
                        <p class="produto_valor">R$ 1.599,99</p>
