        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <img class="produto_imagem img-fluid mt-md-5 " src="../imagens/salto2.jpg" alt="">
                    <!--div com as informacoes do produto-->
                </div>
                <div class="col-md-4 p-3 mt-md-5">
                    <div class="produto_informacoes">
                        <p class="produto_nome">Salto Scarpin Vemelho</p>
                        <p class="produto_cor"> <strong>Cor: </strong>Vermelho</p>
                        <p class="produto_descricao">R$ 199,99</p>
                        <p class="produto_valor">R$ 99,99</p>
