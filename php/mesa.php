        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <img class="produto_imagem img-fluid mt-md-5 " src="../imagens/mesa.jpeg" alt="">
                    <!--div com as informacoes do produto-->
                </div>
                <div class="col-md-4 p-3 mt-md-5">
                    <div class="produto_informacoes">
                        <p class="produto_nome">Conjunto Sala de Jantar Mesa Tampo MDF <br> e Vidro e 4 Cadeiras Lottus</p>
                        <p class="produto_cor"> <strong>Cor: </strong>Preto</p>
                        <p class="produto_descricao">R$ 1.959,90</p>
                        <p class="produto_valor">R$ 1.259,90</p>
