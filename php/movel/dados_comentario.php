...
if (isset($_GET["codigo"])) {
	...
	$consulta = $db_con->prepare('SELECT comentario.*,cliente.nome FROM COMENTARIO INNER JOIN CLIENTE ON(cliente.fk_USUARIO_codigo = comentario.fk_cliente_fk_USUARIO_codigo) WHERE comentarios.fk_PRODUTO_codigo = ' . $codigo);
