...
if (isset($_GET["codigo"])) {
	...
	$consulta = $db_con->prepare('SELECT produto.nome as "nomeProduto",produto.*,empresa.link,usuario.nome as "nomeEmpresa" FROM PRODUTO INNER JOIN EMPRESA ON(produto.fk_EMPRESA_fk_USUARIO_codigo = empresa.fk_USUARIO_codigo) INNER JOIN USUARIO ON(usuario.codigo = empresa.fk_USUARIO_codigo) WHERE produto.codigo = ' . $codigo);
