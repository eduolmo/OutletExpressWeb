...
//if (isset($_GET['limit']) && isset($_GET['offset'])) {
	...
	$consulta = $db_con->prepare("SELECT produto.codigo,imagem,nome,valor_atual,avaliacao,desconto FROM $this->table WHERE UNACCENT(LOWER(nome)) LIKE UNACCENT(LOWER(:pesquisa))");
	$consulta->bindParam(':pesquisa', $pesquisa, PDO::PARAM_STR);
	if($consulta->execute()) {
