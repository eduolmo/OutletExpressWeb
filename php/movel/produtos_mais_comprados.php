...
//if (isset($_GET['limit']) && isset($_GET['offset'])) {
	...
	$consulta = $db_con->prepare("SELECT produto.codigo,imagem,nome,valor_atual,avaliacao,desconto, COUNT(*) as total_vendas FROM PRODUTO    
    INNER JOIN categoria_produto ON(categoria_produto.codigo = fk_categoria_produto_codigo) 
