        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <img class="produto_imagem img-fluid mt-md-5 " src="../imagens/notebook.jpg" alt="">
                    <!--div com as informacoes do produto-->
                </div>
                <div class="col-md-4 p-3 mt-md-5">
                    <div class="produto_informacoes">
                        <p class="produto_nome">Notebook Gamer Lenovo Gaming 3i Intel Core i5-11300H, <br> GeForce GTX1650, 8GB RAM,  SSD 512GB, 15.6 Full HD</p>
                        <p class="produto_cor"> <strong>Cor: </strong>Preto</p>
                        <p class="produto_descricao">R$ 3.999,99</p>
                        <p class="produto_valor">R$ 3.199,99</p>
