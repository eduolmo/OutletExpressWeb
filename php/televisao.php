        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <img class="produto_imagem img-fluid mt-md-5 " src="../imagens/televisao.jpg" alt="">
                    <!--div com as informacoes do produto-->
                </div>
                <div class="col-md-4 p-3 mt-md-5">
                    <div class="produto_informacoes">
                        <p class="produto_nome">Televisão 32 Tela Plana Hd Hdmi Usb Digital</p>
                        <p class="produto_cor"> <strong>Cor: </strong>Preto</p>
                        <p class="produto_descricao">R$ 2.769,99</p>
                        <p class="produto_valor">R$ 1.969,99</p>
